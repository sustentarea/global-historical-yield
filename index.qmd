...
The data used in this report come from the following source:
...
The pipeline is fully reproducible and can be run again at any time. See the [README](https://github.com/danielvartan/global-historical-yield/blob/main/README.md) file in the code repository to learn how to run it.
